...
var GroceriesServiceProvider = /** @class */ (function () {
    function GroceriesServiceProvider(http) {
        this.http = http;
        this.items = [];
        this.baseURL = "https://groceries-server-two.herokuapp.com";
    ...
    GroceriesServiceProvider.prototype.removeItem = function (item) {
        var _this = this;
        console.log("#### Remove Item - id = ", item);
        this.http.delete("https://groceries-server-two.herokuapp.com/api/groceries/" + item._id).subscribe(function (res) {
            _this.items = res;
    ...
    GroceriesServiceProvider.prototype.addItem = function (item) {
        var _this = this;
        this.http.post(this.baseURL + "/api/groceries?" + "name=" + item.name + "&quantity=" + item.quantity, item).subscribe(function (res) {
            _this.items = res;
            _this.dataChangeSubject.next(true);
        });
    };
    GroceriesServiceProvider.prototype.editItem = function (item, index) {
        ...
        this.http.put(this.baseURL + "/api/groceries/" + item._id + "?Name=" + item.name + "&Quantity=" + item.quantity, item).subscribe(function (res) {
            _this.items = res;
            _this.dataChangeSubject.next(true);
        });
    };
...
var TabsPage = /** @class */ (function () {
    ...
    TabsPage = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["m" /* Component */])({template:/*ion-inline-start:"C:\Users\katel\Documents\GitHub\week-6-groceries-app-restful-services-kdunn22\Groceries\src\pages\tabs\tabs.html"*/'<ion-tabs>\n  <ion-tab [root]="tab1Root" tabTitle="Grocery" tabIcon="cart"></ion-tab>\n  <ion-tab [root]="tab2Root" tabTitle="About" tabIcon="information-circle"></ion-tab>\n  <ion-tab [root]="tab3Root" tabTitle="Contact" tabIcon="contacts"></ion-tab>\n</ion-tabs>\n'/*ion-inline-end:"C:\Users\katel\Documents\GitHub\week-6-groceries-app-restful-services-kdunn22\Groceries\src\pages\tabs\tabs.html"*/
        }),
...
var AboutPage = /** @class */ (function () {
    ...
    AboutPage = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["m" /* Component */])({
            selector: 'page-about',template:/*ion-inline-start:"C:\Users\katel\Documents\GitHub\week-6-groceries-app-restful-services-kdunn22\Groceries\src\pages\about\about.html"*/'<ion-header>\n  <ion-navbar>\n    <ion-title>\n      About\n    </ion-title>\n  </ion-navbar>\n</ion-header>\n\n<ion-content padding>\n    <p>My Name is Katelynn Dunn</p>\n    <p>My Student ID is 0939255</p>\n</ion-content>\n'/*ion-inline-end:"C:\Users\katel\Documents\GitHub\week-6-groceries-app-restful-services-kdunn22\Groceries\src\pages\about\about.html"*/
        }),
...
var ContactPage = /** @class */ (function () {
    ...
    ContactPage = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["m" /* Component */])({
            selector: 'page-contact',template:/*ion-inline-start:"C:\Users\katel\Documents\GitHub\week-6-groceries-app-restful-services-kdunn22\Groceries\src\pages\contact\contact.html"*/'<ion-header>\n  <ion-navbar>\n    <ion-title>\n      Contact\n    </ion-title>\n  </ion-navbar>\n</ion-header>\n\n<ion-content>\n  <ion-list>\n    <ion-list-header>Application Contact</ion-list-header>\n    <ion-item>\n      <ion-icon name="ionic" item-start></ion-icon>\n      Contact Details Appear Here\n    </ion-item>\n  </ion-list>\n</ion-content>\n'/*ion-inline-end:"C:\Users\katel\Documents\GitHub\week-6-groceries-app-restful-services-kdunn22\Groceries\src\pages\contact\contact.html"*/
        }),
        __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_1_ionic_angular__["e" /* NavController */]])
    ], ContactPage);
    return ContactPage;
...
var HomePage = /** @class */ (function () {
    ...
    HomePage = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["m" /* Component */])({
            selector: 'page-home',template:/*ion-inline-start:"C:\Users\katel\Documents\GitHub\week-6-groceries-app-restful-services-kdunn22\Groceries\src\pages\home\home.html"*/'<ion-header>\n  <ion-navbar>\n    <ion-title>{{title}}</ion-title>\n  </ion-navbar>\n</ion-header>\n\n<ion-content padding>\n\n  <h3 class="no-item" text-center *ngIf="items.length === 0">\n    No item is available on the list!    \n  </h3>\n  <ion-list>\n    <ion-item-sliding *ngFor="let item of items let i = index">\n      <ion-item>\n        <h2>{{item.name}}</h2>\n        <p>{{item.quantity}}</p>\n      </ion-item>\n      <ion-item-options>\n        <button (click)="editItem(item, i)" ion-button color="primary" icon-start>\n          <ion-icon name="create"></ion-icon>\n          Edit\n        </button>\n\n        <button (click)="shareItem(item, i)" ion-button color="light" icon-start>\n          <ion-icon name="share"></ion-icon>\n          Share\n        </button>\n\n        <button (click)="removeItem(item, i)" ion-button color="secondary" icon-start>\n          <ion-icon name="trash"></ion-icon>\n          Delete\n        </button>\n      </ion-item-options>\n    </ion-item-sliding>\n  </ion-list>\n\n  <ion-fab bottom right>\n    <button (click)="addItem()" ion-fab mini>\n      <ion-icon name="add"></ion-icon>\n    </button>\n  </ion-fab>\n</ion-content>'/*ion-inline-end:"C:\Users\katel\Documents\GitHub\week-6-groceries-app-restful-services-kdunn22\Groceries\src\pages\home\home.html"*/
        }),
        __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_1_ionic_angular__["e" /* NavController */], __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["g" /* ToastController */], __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["a" /* AlertController */], __WEBPACK_IMPORTED_MODULE_2__providers_groceries_service_groceries_service__["a" /* GroceriesServiceProvider */], __WEBPACK_IMPORTED_MODULE_3__providers_input_dialog_service_input_dialog_service__["a" /* InputDialogServiceProvider */], __WEBPACK_IMPORTED_MODULE_4__ionic_native_social_sharing__["a" /* SocialSharing */]])
    ], HomePage);
    return HomePage;
}());
...
var MyApp = /** @class */ (function () {
    ...
    MyApp = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["m" /* Component */])({template:/*ion-inline-start:"C:\Users\katel\Documents\GitHub\week-6-groceries-app-restful-services-kdunn22\Groceries\src\app\app.html"*/'<ion-nav [root]="rootPage"></ion-nav>\n'/*ion-inline-end:"C:\Users\katel\Documents\GitHub\week-6-groceries-app-restful-services-kdunn22\Groceries\src\app\app.html"*/
        }),
